<div {{ $attributes->merge(['class' => $makeCardClass()]) }}>
    ...
    <div class="{{ $makeHeaderClass() }}" style="{{ $makeHeaderStyle() }}">
        ...
        <div class="widget-user-image">
            @if(isset($img))
                <img class="img-circle elevation-2" src="{{ $img }}" style="object-fit: cover;object-position: center center;width: 90px;height:95px" alt="User avatar: {{ $name }}">
    ...
    @if(! $slot->isEmpty())
        <div class="{{ $makeFooterClass() }} bg-white">
